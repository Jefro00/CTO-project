...
let OrganizationsController = class OrganizationsController {
    ...
    async getOrganization(user) {
        return this.orgService.getOrganization(user.organization_id);
    }
    async updateOrganization(user, body) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get current organization details (Section 33)' }),
...
__decorate([
    (0, common_1.Patch)(),
    (0, require_permission_decorator_1.RequirePermission)('organization.update'),
    (0, swagger_1.ApiOperation)({ summary: 'Update organization details (Section 33)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),

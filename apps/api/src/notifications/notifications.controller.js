...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'List notifications for current user (Section 49)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mark notification as read (Section 49)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Mark all notifications as read (Section 49)' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
